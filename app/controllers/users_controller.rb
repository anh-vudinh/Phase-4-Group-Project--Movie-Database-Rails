class UsersController < ApplicationController
    ...
    def create
        if User.find_by(username: params[:username])
            ...
            newUser = User.create(username: params[:username], useremail: params[:useremail] ||= nil, avatar_path: nil, userpwd: params[:password], password: params[:password], login_status: true, account_active: true, is_admin: false)
