class WatchlistCardsController < ApplicationController
    ...
    def create 
        ...
        render json: newWatchListCard, status: :created                                                 #send the new WLC back to front end
    end
    ...
    def deleteWLC
        ...
        render json: watchlist_card, status: :accepted
    end
    ...
    def createOrFindWL(user_id)
        ...
        if possibleWL 
            ...
            Watchlist.create(user_id: user_id, wlname: "first watchlist", is_default: true)             #if there is a current watchlist, store it to pass it's id to create new WL link card
        end                   
    end
end
